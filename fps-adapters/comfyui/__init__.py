...
FacePromptTranslateNode = _safe_import("face_prompt_translate", "FacePromptTranslateNode")  # ★v2.9
...
_all_nodes = {
    ...
    "FacePromptTranslate":      FacePromptTranslateNode,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "FacePromptTranslate":      "🎭 Face Prompt Translate",
